                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select name="clinica" class="form-control">
                              <option name="branco" value="">Selecione</option>
                               <?
                                    if ($area == 'clinica'){
                                        $queryvet = "SELECT CLINICA FROM CLINICAS WHERE EMAIL ='$email' ORDER BY CLINICA ASC";
                                    } else {
                                        $queryvet = "SELECT CLINICA FROM CLINICAS ORDER BY CLINICA ASC";
                                    }
                        		 		
                        				$selectvet = mysqli_query($connect,$queryvet);
                        				
                        				while ($fetchvet = mysqli_fetch_row($selectvet)) {
                        					echo "<option value='".$fetchvet[0]."'>".$fetchvet[0]."</option>";
                        				}
                        		    ?>
                            </select>
                        </div>
