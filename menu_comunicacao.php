  ...
  <div class="collapse navbar-collapse" id="navbarsExample03">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="comunicacao.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        &nbsp;&nbsp;&nbsp;
      </li>
      ...
      <li class="nav-item active">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown03">
          ...
          <a class="dropdown-item" href="formcadastropetcalendar.php">Cadastrar animal para calendário</a>
