...
<main role="main" class="container">
    <div class="starter-template">
        <?
                    	    ...
                    	    $query = "SELECT * FROM EVENTOS WHERE DATA LIKE '".$ano_atu."-%' AND TIPO='Reunião do CMPDA' ORDER BY DATA DESC";
                    		...
                    		if ($reccount != '0'){
                    	        ...
                    	        while ($fetch = mysqli_fetch_row($result)) {
                					...
                					if (strpos($local, 'youtube') !== false) {
                					    echo "<td><a href='".$local."'> Youtube</a></td>";
                					} else {
                					    echo "<td><a href='".$local."'".$local."</a></td>";
                					}
                					echo "</tr>";
                    			}   
                    			        echo "</tbody>";
