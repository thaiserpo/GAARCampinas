...
if($login == "" || $login == null){
		...
		$qtde_vagas = $fetch[18];
		$vagas_disp = $fetch[19];
		$valordiaate6m = $fetch[21];
		$valordiaacima6m = $fetch[22];
		$valordiaadulto = $fetch[23];
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                             <label>Valor pago por animal até 6 meses: </label>
                                <input name="valordiarioate6m" type="text" id="valordiarioate6m" maxlength="30" class="form-control" value="<? echo $valordiarioate6m?>" required>
                        </div>
            <div class="form-group col-md-4">
                             <label>Valor pago por animal acima de 6 meses: </label>
                                <input name="valordiariomais6m" type="text" id="valordiariomais6m" maxlength="30" class="form-control" value="<? echo $valordiariomais6m?>" required>
                        </div>
            <div class="form-group col-md-4">
                             <label>Valor pago por animal com 1 ano ou mais: </label>
                                <input name="valordiarioadulto" type="text" id="valordiarioadulto" maxlength="30" class="form-control" value="<? echo $valordiariomais6m?>" required>
                        </div>
        </div>
