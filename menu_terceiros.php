  ...
  <div class="collapse navbar-collapse" id="navbarsExample03">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="terceiros.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        &nbsp;&nbsp;&nbsp;
      </li>
      <li class="nav-item active">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown03">
          <a class="dropdown-item" href="pesquisapetinterna.php">Pesquisar</a>
        </div>
      </li>
      <li class="nav-item active">
        &nbsp;&nbsp;&nbsp;
      ...
      <li class="nav-item active">
        <a class="nav-link dropdown-toggle" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Anúncios</a>
        <div class="dropdown-menu" aria-labelledby="dropdown03">
          <a class="dropdown-item" href="http://gaarcampinas.org/quero-anunciar/" target="_blank">Cadastrar</a>
          <a class="dropdown-item" href="anuncios.php">Gerenciar</a>
        </div>
      </li>
      <li class="nav-item active">
        &nbsp;&nbsp;&nbsp;
